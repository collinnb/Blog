        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-header">
                    <h1>Post (admin)
                        <small>list of all posts</small></h1>
                </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-1">
                                    ...
                                    <a href="{{ route('postedit', ['id' => $post->id]) }}"><button class="btn btn-default "><span class="glyphicon glyphicon-pencil icon-large"></span></button></a>
                                </div>
                                <div class="col-md-1">
